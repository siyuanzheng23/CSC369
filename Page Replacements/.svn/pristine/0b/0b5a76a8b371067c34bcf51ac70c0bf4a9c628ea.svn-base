...
struct frame {
	...
	int howLong; //for FIFO, recording 'arrival time'
	int lastused; //for LRU, used to record the last time usage of frame
	addr_t vddr; //for OPT, used to hold the virtual address in the frame
};
